...
namespace RealHouzing.DataAccessLAyer.Migrations
{
    ...
    [Migration("20230614193835_mig_Add_HouzingRegister")]
    partial class mig_Add_HouzingRegister
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealHouzing.EntityLayer.Concrete.HouzingRegister", b =>
                {
                    b.Property<int>("HouzingRegisterID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("HouzingRegisterID"), 1L, 1);
                    ...
                    b.HasKey("HouzingRegisterID");

                    b.HasIndex("AppUserID");

                    b.HasIndex("ProductID");

                    b.ToTable("HouzingRegisters");
                });
            ...
            modelBuilder.Entity("RealHouzing.EntityLayer.Concrete.HouzingRegister", b =>
                {
                    b.HasOne("RealHouzing.EntityLayer.Concrete.AppUser", "AppUser")
                        .WithMany()
                        .HasForeignKey("AppUserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RealHouzing.EntityLayer.Concrete.Product", "Product")
                        .WithMany()
